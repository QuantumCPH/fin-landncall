				...
				array(
					'pattern'=>$poboxPattern,
                                ...
                                array(
                                        ...
                                        'min_length' => '"%value%" is too short 5 characters min.',
                                        'invalid'=>sfContext::getInstance()->getI18N()->__('Please enter a valid postal code with 5 digits.'))
			)
		)
	);
