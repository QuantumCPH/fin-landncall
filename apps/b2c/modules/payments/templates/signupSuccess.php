...
<!--           test credit card info
     ...
     ?>
            ...
            <li id="" style="border-style:solid;border-width:3px;width: 320px; padding-left: 10px;">
                <br /><b align="justfy">  <?php echo __('LandNCall AB recommends to activate this service so you <br /> do not have to manually  refill when your account<br />  balance runs low. 100 or 200 Euros each  when the <br /> balances reaches 25 or 50 Euro. This facility is <br /> added to your account in minutes.')?></b>
