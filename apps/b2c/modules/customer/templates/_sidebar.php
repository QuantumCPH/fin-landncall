...
<?php echo __('International calls from 0 cents * With Zero Call Out, you can call the whole world.') ?></p>
                    <a title="<?php echo __('Tell a friend') ?>" rel="bookmark" href="<?php echo url_for('customer/tellAFriend', true) ?>"><span style="color:#000000;"><?php echo __('Read and order') ?></span></a>
		</div>
