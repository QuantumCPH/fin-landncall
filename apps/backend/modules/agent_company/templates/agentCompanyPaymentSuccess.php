...
<div id="sf_admin_container"><h1><?php echo __('Agent Company Payment History') ?>  (<?php if($agentidd>0){ echo  $agent_company->getName(); }else{ echo __("All Agent Companies"); }   ?>) </h1></div><br/>
